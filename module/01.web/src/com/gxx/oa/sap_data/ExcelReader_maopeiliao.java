 ...
 */
public class ExcelReader_maopeiliao {
    /**
     * 导入Excel文件路径
     */
    private static final String IMPORT_EXCEL = "C:\\Users\\sky\\Desktop\\毛坯料2.xls";

    /**
     * 导出Excel文件路径
     */
    private static final String EXPORT_EXCEL = "C:\\Users\\sky\\Desktop\\物料主数据_静态数据准备_毛坯料.xls";

    /**
     * 读取拼音 js 脚本
     */
    private static final String PIN_YIN_JS = "C:\\Users\\sky\\Desktop\\pinyin.js";
    ...
    public static void main(String[] params) throws Exception {
        ...
        for(int i=0;i<rowNum;i++)
        {
            ...
            if(StringUtils.isBlank(fullName)){
                //System.out.println(shortName + "       " + code + "       " + fullName);
                continue;
            }
