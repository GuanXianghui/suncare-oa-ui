 ...
 */
public class ExcelReader_yuancailiao {
    /**
     * 导入Excel文件路径
     */
    private static final String IMPORT_EXCEL = "C:\\Users\\sky\\Desktop\\原材料_原始数据.xls";

    /**
     * 导出Excel文件路径
     */
    private static final String EXPORT_EXCEL = "C:\\Users\\sky\\Desktop\\物料主数据_静态数据准备_原材料.xls";
