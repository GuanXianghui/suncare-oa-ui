...
function processWithJson(){
    ...
    for(var i=0;i<noticeArray.length;i++){
        ...
        html += "<li onclick='showNotice(this, " + noticeArray[i]["id"] + ")'";
        if(isReaded == false){
            html += "style='font-weight: bold;'";
        }
        html += ">" +  "<a href=\"#\">" + noticeArray[i]["title"] + "</a>";
        html += "<span>" + noticeArray[i]["createDate"] + "</span>"
 ...
 * @param noticeId
 */
function showNotice(t, noticeId){
