...
<head>
    ...
    <script type="text/javascript" src="scripts/cloudKnowMyAnswer2.js"></script>
</head>
...
<div id="mainArea">
    ...
    <div id="wikiArea">
        ...
        <div class="wikiList">
            ...
            <dl>
                <dt>
                    <a class="title" href="javascript:window.open('cloudViewKnow2.jsp?id=<%=cloudKnowAsk.getId()%>')" target="_blank">
                        <%
