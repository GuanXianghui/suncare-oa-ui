...
<head>
    ...
    <script language="javascript" type="text/javascript" src="scripts/chooseMultipleContact.js"></script>
    <script type="text/javascript">
        ...
        //初始化选择的用户id
        var initUserIds = "<%=StringUtils.trimToEmpty(request.getParameter("userIds"))%>";
        //初始化选择的用户id数组
        var initUserIdArray = new Array();
    </script>
</head>
