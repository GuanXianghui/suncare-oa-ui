...
<head>
    ...
    <script language="javascript" type="text/javascript" src="scripts/cloudViewKnow2.js"></script>
    <!-- ueditor控件 -->
                ...
                <h2>
                    <span class="d-detail-title">
                        ...
                        <%
                            if(isMine){
                        %>
                        <input value="修改" type="button" class="minBtn" onclick="location.href='cloudKnowUpdateAsk2.jsp?id=<%=cloudKnowAsk.getId()%>'">
